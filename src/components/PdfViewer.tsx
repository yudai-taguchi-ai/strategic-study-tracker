        ...
        >
            ...
            {(isTranslating || translationResult || pendingText) && (
                <div className="fixed inset-0 z-[700] flex items-center justify-center p-4 pointer-events-none">
                    <div
                        className="w-full max-w-2xl bg-[#1A1A1A]/98 backdrop-blur-md border border-white/20 rounded-[32px] shadow-[0_0_80px_rgba(0,0,0,0.8)] pointer-events-auto flex flex-col animate-in fade-in zoom-in-95 duration-300 relative overflow-hidden"
                        style={{ height: '80vh', maxHeight: '1000px' }}
                    >
                        {/* Header */}
                        <div className="flex-none h-[76px] px-6 border-b border-white/10 flex justify-between items-center bg-black/20 z-20">
                        ...
                        {/* Content Area - Force scrolling */}
                        <div
                            className="flex-1 overflow-y-scroll relative z-10 w-full"
                        ...
                        >
                            {isTranslating ? (
                                ...
                                <div className="p-6 md:p-8 space-y-6 pb-20">
                                    ...
                                    <div className="p-6 md:p-8 bg-white text-black rounded-3xl shadow-2xl border border-white/10">
                                        <p className="font-medium leading-[2] text-[15px] whitespace-pre-wrap">{translationResult?.translated}</p>
                                    </div>
                                </div>
                            )}
                        </div>
